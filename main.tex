...
\begin{center}
\Large{\textbf{Remote Sensing Detection and Assessment of Distributed Rooftop Solar Panel Arrays}}
\vspace{0.5cm}
{\color{gray}\hrule}
\medskip
\large\textbf{A report on baseline Computer Vision models and algorithms for Optimizing Data Retrieval} \\
\bigskip

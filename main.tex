...
\begin{center}
    \Large{\textbf{Remote Sensing Assessment and Monitoring of Distributed large and small scale Solar Panel Arrays}}
\vspace{0.5cm}
{\color{gray}\hrule}
\medskip
\large\textbf{A report on baseline Computer Vision extraction methods and algorithms for optimizing generation of a Planetary dataset} \\
\bigskip
\normalsize Alejandro S. Vega-Nogales, Data Scientist @ Maxar, CCOM MS Student \\
\vspace{0.1cm}
SIN: 801-13-7956 \quad github: \href{https://github.com/avega17}{avega17}  \quad email: alejandro.vega1@upr.edu \\
\vspace{0.1cm}
\textit{UPRRP - Computer Science Department} \\
\vspace{0.1cm}
CCOM 6050: Final Project -- Project Final Report
\medskip
\normalsize
\end{center}
{\color{gray}\hrule} 
